...
const MyDataGrid = () => {
    ...
    useEffect(() => {
        if (searchText === '') {
            ...
            const filteredData = rows.filter((row) =>
                Object.values(row).some((value) => String(value).toLowerCase().includes(lowercasedSearchText)),
            );
    ...
    return (
        <div className="block-export-excel">
            ...
            {/* Nút xuất Excel */}
            <Button variant="contained" color="primary" onClick={exportToExcel} sx={{ marginBottom: 2 }}>
                Export to Excel
            </Button>
